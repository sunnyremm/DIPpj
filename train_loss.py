...
def train(net, optimizer):
    ...
    while curr_iter <= cfgs['iter_num']:
        ...
        for data in train_loader:
            ...
            loss_x_j0_record.update(losses['x_j0'].item(), batch_size)
            ...
            loss_t_record.update(losses['t'].item(), batch_size)
            loss_a_record.update(losses['a'].item(), batch_size)
