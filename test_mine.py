...
from tools.config import TEST_SOTS_ROOT, OHAZE_ROOT, TEST_HAZERD_ROOT, TEST_MINE_ROOT
from tools.utils import AvgMeter, check_mkdir, sliding_forward
from model2 import DM2FNet, DM2FNet_woPhy
from datasets import SotsDataset, OHazeDataset, HazeRDDataset, MineDataset
    ...
    with torch.no_grad():
        ...
        for name, root in to_test.items():
            ...
            if len(args['snapshot']) > 0:
                ...
                net.load_state_dict(torch.load(os.path.join(ckpt_path, 'RESIDE_ITS2', args['snapshot'] + '.pth')))
